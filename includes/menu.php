	...
	<div class="container col-md-12 col-sm-12 col-xs-12">	
		...
		<div class="collapse navbar-collapse navHedaerCollapse">
			...
			<div class="col-md-4 col-sm-12 col-xs-12 top10 pull-right">
				...
				<p class="col-md-4 col-sm-4 col-xs-12"><a <?php if(isset($_SESSION["loggedIn"]) and $_SESSION["loggedIn"] == true){echo "href='dashBoard.php'>My Account";} else{ echo "href='register.php'>Sign-up";}?></a></p>
				<p class="col-md-4 col-sm-4 col-xs-12"><a href="orderConfirmation.php">Basket</a></p>
			</div>
