...
<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12 top10">
	<div class="col-md-8 col-sm-6 col-xs-12 text_justity">
		...
		<div class="col-md-7 col-sm-12 top10 col-xs-12"><img class="welcome_image top20" src="images/chef.jpeg"></div>

		<h4 class="top10">Chef : <a href="#">Musnoon Miah</a></h4>
		...
		mother. <br/>Distrusts allowance do knowledge eagerness assurance additions to. 
	...
	<div class="col-md-4  col-sm-6 col-xs-12 text-right pull-right">
		<h3 class="text-right">Opening Time</h3>
